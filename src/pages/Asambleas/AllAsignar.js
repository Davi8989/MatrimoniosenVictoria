                ...
                <div className="row ">
                  <div className="col-sm-3 mt-5 mb-4 text-gred">
                      <div className="search">
                          ...
                          onClick={()=>history.push('/Asambleas/AsignarSiervoMinistro')}>
                              Agregar Asignación
                          </Button>
                      </div>    
                  </div>  
                  <div className="col-sm-3 offset-sm-2 mt-5 mb-4 text-gred" style={{color:"#357a6b"}}>
                      <h2><b>Todas las Asignaciones</b></h2>
                  </div>
                </div>               
                        ...
                        {  comunidad.map(item => (
                            ...
                            <td>
                                ...
                                <Link title="Editar" data-toggle="tooltip"
                                 className="material-icons" to={"/Asambleas/AsignarModificar/"+item.ID_ASIGNACION} style={{color:"#357a6b"}}> &#xE254;</Link>
                                 <Link title="Eliminar" data-toggle="tooltip"
                                 className="material-icons" to={"/Asambleas/EliminarAsignar/"+item.ID_ASIGNACION} style={{color:"#357a6b"}}> &#xE872;</Link>
