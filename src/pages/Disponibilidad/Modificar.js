...
import {urlActualizaDisponibilidad,urlUnaDisponibilidad} from "../../servicio/apirest";
...
function Modificar(props) {
    ...
    const handleSubmit = event => {
        ...
        var data ={
            ...
            HoraDesde:  (form.HoraDesde  ?  form.HoraDesde   : horaD) ,
            HoraHasta:  (form.HoraHasta  ? form.HoraHasta   : horaH) ,
        }   

        let url = urlActualizaDisponibilidad;
        console.log(form)
        axios.post(url, data)
        .then(response => {  
            ...
            if(response.status === 200){
                if(response.data.Codigo === 0){
                    ...
                    swal("¡Error!", response.data.Mensaje, "success");
                    history.push("/Disponibilidad/AllDisponible/"+idusuario);
                }                
            }else{
        ...
        .catch(error => {
            ...
            history.push("/Disponibilidad/AllDisponible/:id");
        })   
    }
    useEffect(() => {
    ...
    return(
        ...
        <h1 style={{color:"#10ab80"}}><b>Editar Disponibilidad</b></h1>
